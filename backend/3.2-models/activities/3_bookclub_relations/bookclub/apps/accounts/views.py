...
def view_profile(request, username):
    ...
    # TODO: Code goes here to retrieve all ReadingLists from the database that
    # were created by the user in question
    user_reading_lists = ReadingList.objects.filter(creator_user=user)

    context = {
        'user': user,
        'user_reading_lists': user_reading_lists
    }
