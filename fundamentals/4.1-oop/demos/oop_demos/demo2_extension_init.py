...
class NovelInfo(BookInfo):
    def __init__(self, title, author, page_count, main_character):
...
new_book = NovelInfo('The Adventures of Tom Sawyer', 'Mark Twain', 300, 'Tom Sawyer')
new_book_2 = NovelInfo('A Tale of Two Cities', 'Charles Dickens', 451, 'Lucie Manette')

new_book_2.print_if_gripping_read()

sortable_title = new_book.without_article()
print('novel title is', sortable_title)
print('the main chracter of new_book is', new_book.main_character)
