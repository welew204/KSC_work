  ...
  return (
    <div className="QuestionContainer">
      ...
      <div className="Question">
        ...
        <p className="Question-explanation">At the end of Season 1, Daenerys Targaryen's dragon eggs were engulfed in fire, in an attempt to hatch them.</p>
      </div>
      ...
      <div className="Question">
        ...
        <p className="Question-explanation">After the direwolf Nymeria flees into the woods following a defensive attack against Prince Joffrey, Cersei Lannister took her wrath out on the sister wolf, Lady.</p>
      </div>
      ...
      <div className="Question">
        ...
        <p className="Question-explanation">Ice was the official sword of the Lord of Winterfell, forged from Valyrian steel and handed down over the ages. It was subsequently melted down to forge two new swords – the Oathkeeper and Widow's Wail.</p>
      </div>
    </div>
  );
}
